...
| Artist CV | [PDF](https://raw.githubusercontent.com/mfbergmann/Bergmann-CV/main/output/Bergmann-CV-Artist.pdf) | [docx](https://raw.githubusercontent.com/mfbergmann/Bergmann-CV/main/output/Bergmann-CV-Artist.docx) |

The academic documents and the artist CVs are drawn from the same record: the academic ones list it in full, the artist ones lead with practice and promote the pre-2019 design credits the academic CV keeps in an archive.

Everything regenerates automatically from a single data source ([`cv.yaml`](cv.yaml)) on every update; the links above always serve the latest build.
